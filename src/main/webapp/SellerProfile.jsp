  ...
  <div class="container">
    <div class="card p-4">
      <div class="text-center mb-4">
        <img src="sellerprofile.jpg" alt="Profile Picture" class="profile-picture">
        <h5 class="card-title mt-3">Wei Da</h5>
      </div>
      <div class="mb-3">
        <label for="phone" class="form-label">Phone</label>
        <input type="text" class="form-control" id="phone" value="012858134141" disabled>
      </div>
      <div class="mb-3">
