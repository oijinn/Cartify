...
<nav id="user-topNavBar">
    ...
    <div class="topNavBar-content">
        ...
        <div class="topNav-menu-container">
            <button>
                <a href="SellerProfile.jsp"><i class="bi bi-person-lines-fill"></i>
                    <h5>My Profile</h5></a>
            </button>
            <button>
                <a href="SellerProductPage.jsp"><i class="bi bi-archive-fill"></i>
                    <h5>My Product</h5></a>
            </button>
            <button>
                <a href="SellerWallet.jsp"><i class="bi bi-archive-fill"></i>
                    <h5>My Wallet</h5></a>
            </button>
            <button>
